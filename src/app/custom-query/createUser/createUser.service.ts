...
export class CreateUserService {
  ...
  getUserDocument(value: { isJuridicPerson: any }) {
    const cpfField = { property: 'cpf', visible: true, required: true, mask: '999.999.999-99' };
    const cnpjField = { property: 'cnpj', visible: true, mask: '99.999.999/9999-99' };
